...
export const questionBank: Question[] = [
  ...
  {
    id: 17,
    question: 'Alat musik tradisional Indonesia yang dimainkan dengan cara dipukul adalah…',
  ...
  {
    id: 22,
    question: 'Bahasa pemrograman yang dikembangkan oleh Brendan Eich pada 1995 adalah…',
  ...
  {
    id: 23,
    question: 'Cabang olahraga manakah yang menggunakan istilah "love" untuk angka nol?',
  ...
  {
    id: 25,
    question: 'Jumlah pemain dalam satu tim sepak bola (termasuk penjaga gawang) adalah…',
    options: ['9', '10', '11', '12'],
    correctIndex: 2,
    category: '⚽ Olahraga',
  },
